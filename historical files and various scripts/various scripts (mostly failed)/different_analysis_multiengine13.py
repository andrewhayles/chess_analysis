...
#   5. ROBUSTNESS: Uses fresh engine processes and timeouts to prevent state corruption or hangs.
#   6. SEAMLESS RESUME: Uses a single, persistent output folder to automatically resume analysis.
...
PLAYER_ANALYSIS_TIMEOUT = 60

PLAYER_TO_ANALYZE = "Desjardins373"
# Set to the number of reliable engines you want for ground truth.
# If using a single strong engine like Stockfish for all roles, set this to 1.
