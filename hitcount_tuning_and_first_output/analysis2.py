...
RUNS_TO_ANALYZE = [
    ...
    "Top 5 Moves, Steep Decay"
]

# *** NEW ***: List any engine names you wish to exclude from the analysis.
# This is useful for removing outliers or specific engines you don't want to see.
ENGINES_TO_EXCLUDE = [
    "stockfish_elo_1320",
    "stockfish_elo_1450",
    "stockfish_elo_1550",
...
def analyze_log_file():
    ...
    # --- Pre-filter the dataframes based on the exclusion list ---
    if ENGINES_TO_EXCLUDE:
        print(f"Excluding the following engines from analysis: {', '.join(ENGINES_TO_EXCLUDE)}")
        log_df = log_df[~log_df['player_engine'].isin(ENGINES_TO_EXCLUDE)]
