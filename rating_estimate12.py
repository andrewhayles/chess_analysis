...
# --- Analysis Control ---
START_MOVE = 5 # Start analysis from this move number in each game.
POSITIONS_PER_GAME = None # Set to None to analyze all player moves after START_MOVE.
...
TEST_ANALYSIS_TIMEOUT = 0.05 # Seconds for benchmark engine analysis
