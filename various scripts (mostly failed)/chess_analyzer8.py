...
# This version uses a single engine with high-resolution UCI strength
# levels (1350-3190, 20-point steps) to generate a precise performance model.
...
ANALYSIS_TIME_LIMIT = 5  # Time in seconds for the oracle engine to find the best move.
...
def build_model_with_uci_levels(engine, move_templates):
    ...
    """
    logging.info("Building performance model using high-resolution UCI strength levels...")
